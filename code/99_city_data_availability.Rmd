...
but only for years up to 2010 and then the current year.
...
with some exclusions (e.g. juvenile victims).
...
Data are [available from 2009](http://gisdata.tucsonaz.gov/datasets?group_ids=b6a49faa168647d8b56e1a06bd53600f&page=2&sort=name&t=police)
in the annual 'incident' datasets including categories that could be used to
create CODE categories, but are mixed in with other calls for service.
