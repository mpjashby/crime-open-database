...
tribble(
  ...
  "Dallas, TX", "possible", "Crime data are [available from June 2014 onwards](https://www.dallasopendata.com/Public-Safety/Police-Incidents/tbnj-w5hb) and appear to include categories that could be matched to the CODE categories",
  "San Jose, CA", "unavailable", "No open crime data are available",
  "Austin, TX", "possible", "Data are [available from 2003 onwards](https://data.austintexas.gov/Public-Safety/Crime-Reports-beta-/fdj4-gpfu)",
  ...
  "Seattle, WA", "problem", "Data [appear to be available](https://data.seattle.gov/Public-Safety/Seattle-Police-Department-Police-Report-Incident/7ais-f98f), with some cases excluded, for several years. However, the website suggests these data will be removed in September 2018. Since they are CC0 licensed, they can continue to be used even after they are withdrawn from the Seattle Open Data website. Unfortunately there are substantial jumps in the number of crimes of many types between years, suggesting some unknown and changing factor influencing the number of crimes",
  ...
  "Nashville, TN", "unavailable", "Data [available](https://data.nashville.gov/Police/Metro-Nashville-Police-Department-Incident-Data-20/we5n-wkcf) with NIBRS codes but only from 2018 onwards",
  "Memphis, TN", "unavailable", "No open crime data are available",
  "Portland, OR", "problem", "Data are [available back to at least 2015](https://www.portlandoregon.gov/police/71978) but are *slightly* difficult to download due to being run on Tableau Public. A substantial minority of cases have neither co-ordinates nor addresses.",
  ...
  "Fresno, CA", "unavailable", "Data are [available](https://moto.data.socrata.com/dataset/Fresno-Police-Department/c943-w8up) but there are no categories that can be used to create NIBRS categories",
  ...
  "Tulsa, OK", "problem", "Data are [available, but only from 2010 to 2014](https://www.cityoftulsa.org/government/departments/information-technology/open-tulsa/open-tulsa-dataset-list/) and are in Shapefile format so haven't been checked",
